...
@customElement('forge-dropdown-menu')
export class ForgeDropdownMenu extends LitElement {
  ...
  private _handleMenuClick(e: MouseEvent) {
    ...
    if (item && item.getAttribute('slot') !== 'trigger') {
  ...
  render() {
    return html`
      ...
      <div class="menu" part="menu" @click="${this._handleMenuClick}">
        <slot></slot>
      </div>
    `;
  }
...
declare global {
  interface HTMLElementTagNameMap {
    'forge-dropdown-menu': ForgeDropdownMenu;
  }
}
